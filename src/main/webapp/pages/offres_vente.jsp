    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="row">
                ...
                List<Annonce> annoncesVenteListe = annoncesRepository.getAnnoncesByType(ConstantData.TypeVente);
                for(Annonce annonce : annoncesVenteListe){
                	%>
